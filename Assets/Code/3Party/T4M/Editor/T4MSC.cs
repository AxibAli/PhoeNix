...
public class T4MSC : EditorWindow {
	...
	void CreateControl2Text()
	{
		...
		TextureI.SetPlatformTextureSettings(tips);
	 ...
	 void ConvertUTerrain()
	{
		...
		Material Tmaterial;
		Tmaterial = new Material (Shader.Find("T4MShaders/ShaderModel2/Unlit/T4M 4 Textures Unlit LM"));
		...
		AssetDatabase.StartAssetEditing();
    		...
    		OBJI.importTangents = ModelImporterTangents.CalculateMikk;
