...
public class Lua_RO_AudioHelper : LuaObject {
	...
	static public int PlayOneShot2DAt_s(IntPtr l) {
		try {
			...
			if(matchType(l,argc,1,typeof(RO.ResourceID),typeof(UnityEngine.Vector3))){
				RO.ResourceID a1;
	...
	static public int PlayOneShot2D_s(IntPtr l) {
		try {
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(RO.ResourceID))){
				RO.ResourceID a1;
				checkType(l,1,out a1);
			...
			else if(matchType(l,argc,1,typeof(UnityEngine.AudioClip))){
				UnityEngine.AudioClip a1;
				checkType(l,1,out a1);
				var ret=RO.AudioHelper.PlayOneShot2D(a1);
				pushValue(l,true);
	...
	static public int PlayOneShotOn_s(IntPtr l) {
		try {
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(UnityEngine.AudioClip),typeof(UnityEngine.AudioSource))){
				UnityEngine.AudioClip a1;
				checkType(l,1,out a1);
			...
			else if(matchType(l,argc,1,typeof(UnityEngine.AudioClip),typeof(UnityEngine.GameObject))){
				UnityEngine.AudioClip a1;
				checkType(l,1,out a1);
	...
	static public int SPlayOneShotOn_s(IntPtr l) {
		try {
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(string),typeof(UnityEngine.AudioSource))){
				System.String a1;
				checkType(l,1,out a1);
				UnityEngine.AudioSource a2;
				checkType(l,2,out a2);
