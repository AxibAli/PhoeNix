...
public class Lua_HttpRequest : LuaObject {
	...
	static public int HTTPGet(IntPtr l) {
		try {
			...
			if(matchType(l,argc,2,typeof(UnityEngine.WWW),typeof(System.Action<UnityEngine.WWW>))){
			...
			else if(matchType(l,argc,2,typeof(string),typeof(System.Action<UnityEngine.WWW>))){
				HttpRequest self=(HttpRequest)checkSelf(l);
				System.String a1;
				checkType(l,2,out a1);
				System.Action<UnityEngine.WWW> a2;
